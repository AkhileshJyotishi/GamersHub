...
const index = ({ initFiles=[],onChange }: { initFiles: string[]|null,onChange:(selectedFiles:string[])=>void }) => {
...
useEffect(()=>{
    ...
    return (
        ...
        { (
        <div className="mt-2">
          <Button onClick={handleUndoRemove} className={clsx("flex gap-2 p-2  rounded-md bg-secondary disabled:bg-transparent ")} disabled={removedFiles.length>0 ? false:true}>
